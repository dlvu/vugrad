...
parser.add_argument('-hs', '--hidden-size',
                dest='hidden_mult',
                help='Multiplier that indicates how many times bigger the hidden layer is than the input layer. ',
                default=4, type=int)                
...
mlp = MLP(input_size=num_features, output_size=num_classes,hidden_mult=args.hidden_mult)
